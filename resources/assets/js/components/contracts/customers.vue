...
//                        width:210,
        ...
        methods: {
            ...
            searchName: _.debounce(function () {
                ...
                axios.get('/customers/search/'+this.customerName).then(res=>{
            ...
            newCustomer(){
                axios.post('/customers/', this.singleNew).then(res=>{
            ...
            edit(){
              axios.patch('/customers/'+this.singleEdit.id, this.singleEdit).then(res=>{
                  this.$Message.success('编辑成功');
            ...
            remove (index) {
                axios.delete('/customers/'+this._customers[index].id).then(res=>{
