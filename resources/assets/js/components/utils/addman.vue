...
//                        break
            ...
            search(){
                ...
                switch (this.type){
                    case 1:
                        axios.get('/addman/users/'+this.manName).then(res=>{
                            this.rows = res.data
                        })
                        break
                    case 2:
                    ...
                    case 4:
                        ...
                        break
                    case 5:
                        axios.get('/addman/cus2s/'+this.manName).then(res=>{
                            this.rows = res.data
                        })
                        break
//                    case 6:
//                        axios.get('/addman/cus/'+this.manName).then(res=>{
//                            this.rows = res.data
//                        })
//                        break
                    case 7:
                        axios.get('/addman/profession/'+this.manName).then(res=>{
                            this.rows = res.data
                        })
                        break
                    default:
